...
window.MRA_BLOCKS.push({
  ...
  concepts: [
    ...
    { term: "The 4 steps of Market Research", definition: "Define → Develop → Implement → Interpret.", details: "Define the problem & objectives · Develop the plan · Implement (collect & analyze data) · Interpret & report findings.", source: "Day 1 · slide 13" },
    ...
    { term: "Market Analysis", definition: "The broad finding — e.g. 'website data shows sales decreased 30% within the last 6 months'.", source: "Day 1 · slide 16" },
    { term: "Market Analytics (granular)", definition: "The deeper, granular insight — e.g. 'most of the user loss came from mobile users aged 12–35, mostly Instagram users'.", source: "Day 1 · slide 16" },
    ...
    { term: "Research vs. Analytics (integration)", definition: "Research explains the WHY; Analytics shows the WHAT and HOW. Combined → tailored experiences and a better customer journey.", source: "Day 2 · slide 8" },
    { term: "Long-term marketing decisions", definition: "Target market selection · brand positioning & value proposition · product/service offering · market entry · growth strategy.", source: "Day 2 · slide 6" },
    { term: "Short-term marketing decisions", definition: "Budget allocation · pricing · channel/distribution · promotional & content · team structure.", source: "Day 2 · slide 7" },
